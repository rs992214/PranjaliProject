<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="pages_Default2" %>
                        ...
                        <div class="form-section" style="max-width: 500px;">
                            ...
                            <i class="ace-icon fa fa-id-card"></i>
                                ...
                                <div class="form-group form-box">
                                    ...
                                    <asp:TextBox ID="txtpassword" runat="server" CssClass="input-text" placeholder="Enter Password" TextMode="Password"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Enter Password" Display="Dynamic" ForeColor="Red" ControlToValidate="txtpassword" ValidationGroup="Sign" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <i class="flaticon-password"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btnPaytm" runat="server" Text="Register" CssClass="btn-md btn-theme btn-block" ValidationGroup="Sign" OnClick="btnPaytm_Click" />
